...
public class Strings {
    ...
    public static final String WELCOME = "Willkommen bei Soup It. Als dein persönlicher Assistent begleite ich dich bei der Suppenzubereitung. Welche Zutaten möchtest du verwenden?";
