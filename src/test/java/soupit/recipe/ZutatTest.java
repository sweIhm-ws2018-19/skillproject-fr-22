...
class ZutatTest {
    ...
    private String falseString = "milch";


    private Zutat nullTest = new Zutat(null,null);
    private Zutat einzahlTest = new Zutat(testEinzahl,"kartoffel");
    ...
    void getGrammatGeschlechtTest() {
        ...
        assertEquals(testEinzahl,einzahlTest.getGrammatGeschlecht());
    }
}